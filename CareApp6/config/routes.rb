CareApp3::Application.routes.draw do
  # Routes for the Permission resource:
  # CREATE
  get '/permissions/new', controller: 'permissions', action: 'new', as: 'new_permission'
  post '/permissions', controller: 'permissions', action: 'create'

  # READ
  get '/permissions', controller: 'permissions', action: 'index', as: 'permissions'
  get '/permissions/:id', controller: 'permissions', action: 'show', as: 'permission'

  # UPDATE
  get '/permissions/:id/edit', controller: 'permissions', action: 'edit', as: 'edit_permission'
  put '/permissions/:id', controller: 'permissions', action: 'update'

  # DELETE
  delete '/permissions/:id', controller: 'permissions', action: 'destroy'
  #------------------------------
